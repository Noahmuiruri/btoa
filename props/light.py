...
class ArnoldLight(PropertyGroup):
    ...
    cast_shadows: BoolProperty(name="Cast Shadows", description="", default=True)
    cast_volumetric_shadows: BoolProperty(name="Cast Volumetric Shadows", description="", default=True)
    shadow_density: FloatProperty(name="Shadow Density", description="", default=1)
    shadow_color: FloatVectorProperty(name="Shadow Color", description="", size=3, min=0, max=1, subtype='COLOR')
    samples: IntProperty(name="Samples", description="", min=0, max=100, default=1)
    normalize: BoolProperty(name="Normalize", description="", default=True)
    #affect_diffuse: BoolProperty(name="Emit Diffuse", description="", default=True)
    #affect_specular: BoolProperty(name="Emit Specular", description="", default=True)
    #affect_volumetrics: BoolProperty(name="Affect Volumetrics", description="", default=True)
    camera: FloatProperty(name="Camera", description="", min=0, soft_max=1, default=1)
    diffuse: FloatProperty(name="Diffuse", description="", min=0, soft_max=1, default=1)
    specular: FloatProperty(name="Specular", description="", min=0, soft_max=1, default=1)
    transmission: FloatProperty(name="Transmission", description="", min=0, soft_max=1, default=1)
    sss: FloatProperty(name="SSS", description="", min=0, soft_max=1, default=1)
    indirect: FloatProperty(name="Indirect", description="", min=0, soft_max=1, default=1)
    max_bounces: IntProperty(name="Max Bounces", description="", min=0, default=999)
    #volume_samples: IntProperty(name="Volume Samples", subtype='UNSIGNED', min=0, default=2)
    volume: FloatProperty(name="Volume", min=0, soft_max=1, default=1)
    ...
    penumbra_angle: FloatProperty(name="Penumbra Angle", description="", min=0, max=math.pi, default=0.1178097, subtype='ANGLE', update=update_penumbra_angle)
    ...
    soft_edge: FloatProperty(name="Soft Edge", description="", min=0, max=1)
    area_roundness: FloatProperty(name="Roundness", description="", min=0, max=1)
    portal: BoolProperty(name="Is Portal Light")
